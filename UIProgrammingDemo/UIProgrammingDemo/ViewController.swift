...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var thingsLabel = UILabel(frame: CGRect(x: 10, y: 35
        , width: UIScreen.mainScreen().bounds.width - 20, height: 60))
    var pinButton = UIButton(frame: CGRect(x: 10, y: 10
        , width: (UIScreen.mainScreen().bounds.width - 40)/3, height: 40))
    ...
    var inviteFriends = UIButton(frame: CGRect(x: 30 + 2 * (UIScreen.mainScreen().bounds.width - 40)/3, y: 10
        , width: (UIScreen.mainScreen().bounds.width - 40)/3, height: 40))
    ...
    override func viewDidLoad() {
        ...
        thingsLabel.text = "Pearl Tower, The Bund, World Financial Center, French Concession, Aquarium, Jing An Temple, etc."
